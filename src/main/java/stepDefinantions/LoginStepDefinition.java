...
public class LoginStepDefinition {
	...
	public void verify_user_created() throws InterruptedException {
		Thread.sleep(3000);

		driver.findElement(By.xpath("//a[contains(text(),'Contacts')]")).click();
		Thread.sleep(2000);
		String s1 = driver.findElement(By.xpath("//a[contains(text(),'pooja sanghani')]")).getText();
		System.out.println(s1);
		Assert.assertEquals("pooja sanghani", s1);
	}
			
	
	@Then("^close the browser$")
	public void cloase_the_browser() {
		driver.close();
	}
